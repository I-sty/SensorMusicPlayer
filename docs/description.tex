...
\end{lstlisting}
\subsection{Demo}
Using this module (\textit{PythonShell}) you easily can call a Python script from your Node.js server.
\par Steps to present the non-Android part of the project:
\begin{enumerate}
\item{}
\end{enumerate}
